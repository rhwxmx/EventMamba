...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default='/home/rhwdmx/github/eventmamba/EventMamba/data/dailydvs/', help="path to dataset")
    parser.add_argument('--num_category', default=12, type=int, help='the category of action recogniton')
    parser.add_argument('--num_point', type=int, default=2048, help='Point Number')
    parser.add_argument("--log_path", type=str, default='./tensorboard_log/', help="path to tesnorboard_log")
    parser.add_argument("--log_name", type=str, default='/dailydvs_2048_1024', help="path to tesnorboard_log")
