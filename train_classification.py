...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default='/home/rhwdmx/github/eventmamba/EventMamba/data/dvsgesture/', help="path to dataset")
    ...
    parser.add_argument("--log_name", type=str, default='/dvsgesture_1024_512_24_batch256', help="path to tesnorboard_log")
